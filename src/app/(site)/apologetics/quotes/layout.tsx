...
export const metadata = createPageMetadata({
    title: 'Quotes',
    description:
        'Patristic and historical quotations from early church fathers and primary sources, indexed from various Reformed theological works including William Perkins\'s apologetic writings.',
